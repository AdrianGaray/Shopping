    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return View(await _context.Users
                  .Include(u => u.City)         // relacion de 1° nivel - Include
                  .ThenInclude(c => c.State)    // relacion de 2° nivel - ThenInclude
                  .ThenInclude(s => s.Country)  // relacion de 3° nivel - ThenInclude
                  .ToListAsync());
        }
